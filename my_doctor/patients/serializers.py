...
class PatientResgistrationSerializer(serializers.Serializer):
    ...
    rel_type = serializers.CharField(allow_null=True)
    relation = serializers.CharField(allow_null=True)
    ph_no=serializers.CharField()
    s_ph_no=serializers.CharField(allow_null=True)
    pref_lang = serializers.CharField(allow_null=True)
    ...
    medical_history = serializers.CharField(allow_null=True)
    other_history=serializers.CharField(allow_null=True)
    groups=serializers.CharField(allow_null=True)
