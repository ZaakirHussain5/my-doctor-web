...
sinchClient = new SinchClient({
	applicationKey: '204cbe36-7d2f-4b77-b438-3d07c3a3a19b',
...
$('button#createUser').on('click', function (event) {
	...
	var signUpObj = {};
	signUpObj.username = 'patient';
	signUpObj.password = '1234';
...
$('button#loginUser').on('click', function (event) {
	...
	var signInObj = {};
	signInObj.username = 'patient';
	signInObj.password = '1234';
...
callClient.addEventListener({
	onIncomingCall: function (incomingCall) {
		...
		audioRingTone.src = '/media/style/phone_ring.wav';
...
$('button#hangup,button#hangupVideo').click(function (event) {
	event.preventDefault();
